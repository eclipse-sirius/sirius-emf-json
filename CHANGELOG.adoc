...
- https://github.com/eclipse-sirius/sirius-emf-json/issues/84[#84] `IJsonResourceProcessor.preDeserialization(...)` is now called before namespace resolution. Processors relying on namespace prefixes already being available must be updated.
...
- https://github.com/eclipse-sirius/sirius-emf-json/issues/84[#84] Process document migrations before namespace resolution.
