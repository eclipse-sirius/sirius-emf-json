 ...
 */
@RunWith(Suite.class)
@SuiteClasses({ AnnotationSaveTests.class, AttributesSaveTests.class, ClassSaveTests.class, DataTypeSaveTests.class, EnumerationsSaveTests.class, ExtendedMetaDataTests.class, JsonHelperDataLoadTests.class,
